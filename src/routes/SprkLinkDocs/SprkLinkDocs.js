...
const SprkLinkDocs = () => (
  <CentralColumnLayout>
    ...
    <ExampleContainer>
      <SprkLink variant="hasIcon" idString="link-1">
        <SprkIcon
          additionalClasses="sprk-b-Link__icon sprk-c-Icon--l sprk-c-Icon--stroke-current-color sprk-c-Icon--filled-current-color"
